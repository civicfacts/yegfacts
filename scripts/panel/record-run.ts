 ...
 * records which CLI at which version ran which model against which prompt hash
 * under which methodology version, and when. Bit-exact reproduction of a
 * subscription-CLI model is impossible; saying exactly what ran is not.
 *
