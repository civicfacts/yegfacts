...
Two things the seat could not check. The 42-counter spatial join: the editor reproduced it from YF-EV-0162 and YF-EV-0145 on six named counters to the tenth of a metre, including the two the brief calls closest (96 Street S of Jasper Ave at 6.7 m ON ROAD against 55.2 m OFF ROAD, and High Level Bridge East at 1.9 m OFF ROAD). And YF-EV-0026, whose archived bytes sit in the main checkout rather than in this worktree, `evidence/private/` being gitignored and therefore per-worktree; those bytes do carry "The City of Edmonton estimates one in four cyclists ride all-year round." verbatim. -->
