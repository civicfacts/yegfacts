...
# The frozen brief (brief.md, sha256 083f4a63800a1d12f348c0186fec8dd01c6d47c557049d24b5f5149feaa02018)
...
lanes." No instrument on the Edmonton record can settle this in either
direction on the as-of date. The City runs no probability-sample survey
asking whether residents support these routes, and Stew's searches found
no published poll of Edmonton or of an affected neighbourhood on the
question. Every count the argument reaches for — petition signatures,
open-house attendance, responses to an open survey, speakers at a council
hearing, email and phone inquiry volume, comments on a post — records who
chose to take part, which is not a sample of a neighbourhood or of a
city. On this record Supported is unreachable and so is Contradicted, and
a proposition on which only one verdict is possible states nothing. It
reopens if a probability-sample survey of Edmontonians, or of residents
of an affected neighbourhood, asking about these routes, is published.
This is the register's own triage reason applied, not a new judgement.
...
Implementation Acceleration" and the City describes the programme as an
acceleration. A verdict either way would tell neither side anything. That
is test 3 of the retro-triage in methodology v1.19, applied before the
panel run rather than after it.

**Out of scope on right-of-reply grounds.** One captured wording names a
sitting councillor as the person who failed to inform residents. An
accusation against a named individual is declined under the register's
`ground: right-of-reply`, because the site has no way to put it to the
person named. The claim below is about the City's engagement record and
does not turn on any individual's conduct.
...
- Verifiability: the City publishes a project page with a route table and
  ...
  bulletins and fact sheets, and an engagement portal. Whether an
  engagement activity happened on a named route before a named date is
  answerable from those records in either direction.
...
fact about a Facebook thread and is not evidence about Edmonton, and it
must not shade the reading of the record in either direction.
...
rather than answering a measurable cousin of it.
...
4. What the City's own engagement records report about the balance of
   ...
   people who took part, under that name, with the method by which they
   were recruited. It is never reported as what residents think, what
   Edmontonians think, or what a neighbourhood thinks, and it may not be
   cited for or against any proposition about public opinion.
5. The volume of email and phone inquiries the City reports having
   received about the programme, traced to the City record that carries
   it, with its date and its period. Reported as inquiry volume, under
   that name, and subject to the same prohibition as qualification 4.
...
No number produced under this brief may be offered, in the story or
anywhere else, as a measure of what residents or Edmontonians want. That
includes petition signatures, open-house attendance, responses to an open
survey, the balance of speakers at a council hearing, the volume of email
and phone inquiries, and comments on a social media post. Each of those
records who chose to take part. None of them is a sample of a population,
and none may stand in for one, in a headline, a standfirst, a one-line
answer or a TL;DR. Where a brief predeclares what it will not claim, the
story may not later claim it.
...
Geography: the City of Edmonton, and the routes in set S.

Time: as fixed above.

Out of scope, and registered as separate questions on the public
register: who spoke at the 2026-08-26 committee hearing and in what
balance (`council-hearing`); what was planned for the bike lane outside
the Holyrood school and what stopped it (`holyrood-school-lane`); how
much parking each route removes (`on-street-parking`); how much the
programme costs and how that compares with roads (`active-transportation`,
`bike-vs-road-spending`); whether people use the lanes
(`cycling-volumes`); whether the routes were already under contract
(`routes-already-committed`); what mandate council has
(`council-mandate`).

Also out of scope: policy questions of every kind, including whether the
routes should be built, whether council should have paused them, whether
the Province should legislate on municipal bike-lane authority, and
whether any individual route's design is right.
...
3. **City of Edmonton, The Bike Plan (2020)**,
   ...
   https://www.edmonton.ca/sites/default/files/public-files/BikePlan-ImplementationGuide.pdf
   Answers: what the plan-level engagement was about, at what geographic
   level, and whether the plan itself fixed route locations or left them
   to later design.
4. **"What We Heard Report: Edmonton Bike Plan Phase 2 Engagement",
   2019-10-10**,
   ...
   and any later phase report the Bike Plan cites. Answers: how many
   people took part in the plan-level engagement, by what methods, over
   what period, and whether participants were asked about specific route
   or lane locations. Reviewers report these figures; this brief states
   none of them.
5. **The City's engagement portal**, https://engaged.edmonton.ca
   Answers: whether any route in S has a project page, a survey or a
   comment period, and with what dates.
6. **Per-route construction bulletins and fact sheets published on
   edmonton.ca**, for example
   https://www.edmonton.ca/sites/default/files/public-files/2025-Active-Transportation-Network-Expansion-Program-Construction-Bulletin-127-Avenue.pdf
   https://www.edmonton.ca/sites/default/files/public-files/2025-Active-Transportation-Network-Expansion-Program-Construction-Bulletin-Victoria-Park-Road.pdf
   https://www.edmonton.ca/sites/default/files/public-files/28Avenue-ConstructionBulletin-and-RouteMap.pdf
   https://www.edmonton.ca/sites/default/files/public-files/documents/active-transportation-network-expansion-163-street-fact-sheet.pdf
   Answers: what the City published for a given route, when, whether it
   invited comment or only announced work, and whether the document
...
- A City page saying that planning and design drew on earlier engagement
  establishes what the City says it drew on. It never establishes that
  engagement about a specific route happened. Keep the two apart in every
  evidence item, and say which one the record you cite establishes.
- Publication is not notification, and notification is not engagement. A
  route appearing in a table on a City web page, or a construction
  bulletin existing as a published PDF, establishes that the City
  produced the document. It does not establish that anyone living on the
  route received it, and it does not establish that anyone was invited to
  comment. Three different things; name which one each record supports.
- Never convert a count of participants into a measure of opinion. A
  petition, an open survey, a speakers list, an inquiry log and an
  open-house sign-in sheet each record who chose to take part. If you
  report such a figure, report it under that name and state what it
  cannot show.
- Search as hard for engagement that did happen as for engagement that
  did not. An absence found after two searches is not the same as an
  absence found after checking the report, the attachments, the project
  page, the per-route fact sheets, the engagement portal and the
...
- Quote operative statements from the City's own documents and name the
  ...
  source of a figure in a verdict.
